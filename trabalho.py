...
Original file is located at
    https://colab.research.google.com/drive/1ucmWddip34vqzAeF4gcn4Aq-rGRSj1dD
"""
    ...
    while(tem_arquivo == 'S'): #Voce possui um arquivo (S/N):
        ...
        if Path(nome_arq).is_file():
          ...
          if len(lstColumnsX) > 2:
            ...
            # for i in lstvalores:
                 #predictionColumns.append(float(lstvalores[0][i]))
            # break        
            #Se não:
...
import pandas as pd
lstvalores = pd.read_csv('valores.csv', sep=',',header = None)
for i in lstvalores:
  teste = int(lstvalores[i])
  print(teste)